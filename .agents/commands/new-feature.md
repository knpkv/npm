# New Feature Development - Effect-TS Projects

## 🚨 MANDATORY SPEC-DRIVEN DEVELOPMENT 🚨

This command enforces a rigorous **5-phase development process** for substantial new features in Effect-based projects. This process ensures systematic development, comprehensive documentation, and alignment with Effect-TS best practices.
...
- Create `design.md` including:
  - **Effect-TS Patterns**: Generator functions, error handling, resource management
...
This workflow ensures systematic, high-quality feature development that maintains Effect-TS standards for type safety, functional programming patterns, and comprehensive documentation.
