...
For `packages/browser-pairing/src/**`, schemas that expose a credential field must be documented as credential-bearing; do not describe those payloads as secret-free. Credential-free summaries may retain a secret-free description.
