...
export interface components {
    schemas: {
        ...
        AttendanceReportDtoV1: {
            /** @description List of entities */
            entities?: components["schemas"]["AttendanceDto"][];
        };
        ...
        DetailedReportFilterV1: {
             ...
             */
            timeZone?: string;
            userCustomFields?: components["schemas"]["CustomFieldFilterV1"][];
            userGroups?: components["schemas"]["ContainsUsersFilterV1"];
            /**
             * @description If provided, you'll get filtered result including reports with provided user locale.
             * @example en
        ...
        SharedReportDtoV1: {
            ...
            fixedDate?: boolean;
            /**
             * @description Represents a shared report identifier across the system.
        ...
        SharedReportRequestV1: {
            ...
            isPublic?: boolean;
            /**
             * @description Represents a shared report's name
             * @example Weekly 1
             */
            name?: string;
            /**
        ...
        TimeEntryDetailedReportDto: {
            ...
            totals?: components["schemas"]["TimeEntryReportTotals"][];
        };
        ...
        UpdateSharedReportRequestV1: {
            ...
            isPublic?: boolean;
            /**
             * @description Represents a shared reports name.
        ...
        AuditLogDtoV1: {
            /**
             * @description Represents an audit log action type.
            ...
            /**
             * @description Represents the current value of the modified entity
             * @example {"projectName":"New Project","client":"","archived":false,"visibility":true,"members":["John Doe"],"billableByDefault":true,"note":"","billableRate":0,"costRate":null,"currency":"USD","activeEstimate":"NONE","estimateType":null,"estimate":null,"recurringEstimate":false,"interval":null,"month":null,"dayOfWeek":null,"dayOfMonth":null,"hour":null}
             */
            content?: string;
            /**
             * @description Represents the previous value of the modified entity.
             * @example null
             */
            previousContent?: string;
            /**
             * @description Represents a timestamp of when the audit log entry was created.
             * @example 2025-05-01T11:15:00Z
             */
            timestamp?: string;
            /**
            ...
            /**
             * @description Represents a user identifier across the system.
             * @example 45b687e29ae1f428e7ebe123
             */
            userId?: string;
            /**
        ...
        PageableV1ListAuditLogDtoV1: {
            response?: components["schemas"]["AuditLogDtoV1"][];
        };
        /** @description Represents the audit log author filter. */
        authors: {
            /**
             * @description Represents a set of author user ids. Include "SYSTEM" in this set to retrieve system related audit logs.
             * @example [
             *       "45b687e29ae1f428e7ebe123",
             *       "67s687e29ae1f428e7ebe678",
             *       "SYSTEM"
...
export interface operations {
    ...
    generateAttendanceReport: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["AttendanceReportFilterV1"];
            };
        };
        responses: {
            /** @description OK */
    ...
    generateDetailedReport: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["DetailedReportFilterV1"];
            };
        };
        responses: {
            /** @description OK */
    ...
    generateSummaryReport: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["SummaryReportFilterV1"];
            };
        };
        responses: {
            /** @description OK */
    ...
    generateWeeklyReport: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["WeeklyReportFilterV1"];
            };
        };
        responses: {
            /** @description OK */
    ...
    getAuditLogs: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AuditLogGetRequestV1"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PageableV1ListAuditLogDtoV1"];
                };
            };
        };
    };
