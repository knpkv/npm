...
export const SearchContentByCQLParams = Schema.Struct({ "cql": Schema.String, "cqlcontext": Schema.optionalKey(Schema.String), "expand": Schema.optionalKey(Schema.Array(Schema.String)), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const CreateOrUpdateAttachmentsRequestFormData = Schema.Json.annotate({ "expected": "JSON value" })
...
export const DownloadAttatchmentParams = Schema.Struct({ "version": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "status": Schema.optionalKey(Schema.Array(Schema.String)) })
...
export const GetDescendantsOfTypeParams = Schema.Struct({ "depth": Schema.optionalKey(Schema.Literals(["all", "root", "<any positive integer argument in the range of 1 and 100>"])), "expand": Schema.optionalKey(Schema.Array(Schema.String)), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetWatchesForPageParams = Schema.Struct({ "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetWatchesForSpaceParams = Schema.Struct({ "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetRestrictionsParams = Schema.Struct({ "expand": Schema.optionalKey(Schema.Array(Schema.Literals(["restrictions.user", "read.restrictions.user", "update.restrictions.user", "restrictions.group", "read.restrictions.group", "update.restrictions.group", "content"]))), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetAllLabelContentParams = Schema.Struct({ "name": Schema.String, "type": Schema.optionalKey(Schema.Literals(["page", "blogpost", "attachment", "page_template"])), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) })
...
export const GetGroupsParams = Schema.Struct({ "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "accessType": Schema.optionalKey(Schema.Literals(["user", "admin", "site-admin"])) })
...
export const SearchGroupsParams = Schema.Struct({ "query": Schema.String, "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "shouldReturnTotalSize": Schema.optionalKey(Schema.Boolean) })
...
export const GetGroupMembersByGroupIdParams = Schema.Struct({ "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "shouldReturnTotalSize": Schema.optionalKey(Schema.Boolean), "expand": Schema.optionalKey(Schema.Array(Schema.Literals(["operations", "personalSpace", "isExternalCollaborator"]))) })
...
export const GetTasksParams = Schema.Struct({ "key": Schema.optionalKey(Schema.String), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const FindTargetFromSourceParams = Schema.Struct({ "sourceStatus": Schema.optionalKey(Schema.String), "targetStatus": Schema.optionalKey(Schema.String), "sourceVersion": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "targetVersion": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "expand": Schema.optionalKey(Schema.Array(Schema.Literals(["relationData", "source", "target"]))), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetRelationshipParams = Schema.Struct({ "sourceStatus": Schema.optionalKey(Schema.String), "targetStatus": Schema.optionalKey(Schema.String), "sourceVersion": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "targetVersion": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "expand": Schema.optionalKey(Schema.Array(Schema.Literals(["relationData", "source", "target"]))) })
...
export const CreateRelationshipParams = Schema.Struct({ "sourceStatus": Schema.optionalKey(Schema.String), "targetStatus": Schema.optionalKey(Schema.String), "sourceVersion": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "targetVersion": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) })
...
export const SearchByCQLParams = Schema.Struct({ "cql": Schema.String, "cqlcontext": Schema.optionalKey(Schema.String), "cursor": Schema.optionalKey(Schema.String), "next": Schema.optionalKey(Schema.Boolean), "prev": Schema.optionalKey(Schema.Boolean), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "includeArchivedSpaces": Schema.optionalKey(Schema.Boolean), "excludeCurrentSpaces": Schema.optionalKey(Schema.Boolean), "excerpt": Schema.optionalKey(Schema.Literals(["highlight", "indexed", "none", "highlight_unescaped", "indexed_unescaped"])), "sitePermissionTypeFilter": Schema.optionalKey(Schema.Literals(["all", "externalCollaborator", "none"])), "_": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "expand": Schema.optionalKey(Schema.Array(Schema.String)) })
...
export const SearchUserParams = Schema.Struct({ "cql": Schema.String, "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "expand": Schema.optionalKey(Schema.Array(Schema.String)), "sitePermissionTypeFilter": Schema.optionalKey(Schema.Literals(["all", "externalCollaborator", "none"])) })
...
export const GetThemesParams = Schema.Struct({ "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetContentsWithStateParams = Schema.Struct({ "state-id": Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })), "expand": Schema.optionalKey(Schema.Array(Schema.String)), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })).check(Schema.isLessThanOrEqualTo(100).annotate({ "expected": "a value less than or equal to 100" }))), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetLabelsForSpaceParams = Schema.Struct({ "prefix": Schema.optionalKey(Schema.Literals(["global", "my", "team"])), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
...
export const GetBlueprintTemplatesParams = Schema.Struct({ "spaceKey": Schema.optionalKey(Schema.String), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "expand": Schema.optionalKey(Schema.Array(Schema.Literals(["body", "body.storage"]))) })
...
export const GetContentTemplatesParams = Schema.Struct({ "spaceKey": Schema.optionalKey(Schema.String), "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "expand": Schema.optionalKey(Schema.Array(Schema.Literals(["body", "body.storage"]))) })
...
export const GetGroupMembershipsForUserParams = Schema.Struct({ "accountId": Schema.String, "start": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) })
