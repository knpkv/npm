...
export const SpaceStatus = Schema.Literals(["current", "archived", "trashed"]).annotate({ "description": "The status of the space." })
...
export const GetSpacesParams = Schema.Struct({ "ids": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())).check(Schema.isMaxLength(250))), "keys": Schema.optionalKey(Schema.Array(Schema.String).check(Schema.isMaxLength(250))), "type": Schema.optionalKey(Schema.Literals(["global", "collaboration", "knowledge_base", "personal", "system", "onboarding", "xflow_sample_space"])), "status": Schema.optionalKey(Schema.Literals(["current", "archived", "trashed"])), "labels": Schema.optionalKey(Schema.Array(Schema.String)), "favorited-by": Schema.optionalKey(Schema.String), "not-favorited-by": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(SpaceSortOrder), "description-format": Schema.optionalKey(SpaceDescriptionBodyRepresentation), "include-icon": Schema.optionalKey(Schema.Boolean), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt()).check(Schema.isGreaterThanOrEqualTo(1)).check(Schema.isLessThanOrEqualTo(250))) })
