...
export const AttachmentSortOrder = Schema.Literals(["created-date", "-created-date", "modified-date", "-modified-date"]).annotate({ "description": "The sort fields for attachments. The default sort direction is ascending. To sort in descending order, append a `-` character before the sort field. For example, `fieldName` or `-fieldName`.", "identifier": "AttachmentSortOrder" })
export type ContentStatus = "current" | "draft" | "archived" | "historical" | "trashed" | "deleted" | "any"
export const ContentStatus = Schema.Literals(["current", "draft", "archived", "historical", "trashed", "deleted", "any"]).annotate({ "description": "The status of the content.", "identifier": "ContentStatus" })
...
export const Version = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "description": "Date and time when the version was created. In format \"YYYY-MM-DDTHH:mm:ss.sssZ\".", "format": "date-time" })), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Message associated with the current version." })), "number": Schema.optionalKey(Schema.Number.annotate({ "description": "The version number.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "minorEdit": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Describes if this version is a minor version. Email notifications and activity stream updates are not created for minor versions." })), "authorId": Schema.optionalKey(Schema.String.annotate({ "description": "The account ID of the user who created this version." })) }).annotate({ "identifier": "Version" })
export type AttachmentLinks = { readonly "webui"?: string, readonly "download"?: string }
export const AttachmentLinks = Schema.Struct({ "webui": Schema.optionalKey(Schema.String.annotate({ "description": "Web UI link of the content." })), "download": Schema.optionalKey(Schema.String.annotate({ "description": "Download link of the content." })) }).annotate({ "identifier": "AttachmentLinks" })
export type MultiEntityLinks = { readonly "next"?: string, readonly "base"?: string }
export const MultiEntityLinks = Schema.Struct({ "next": Schema.optionalKey(Schema.String.annotate({ "description": "Used for pagination. Contains the relative URL for the next set of results, using a cursor query parameter.\nThis property will not be present if there is no additional data available." })), "base": Schema.optionalKey(Schema.String.annotate({ "description": "Base url of the Confluence site." })) }).annotate({ "identifier": "MultiEntityLinks" })
export type Label = { readonly "id"?: string, readonly "name"?: string, readonly "prefix"?: string }
export const Label = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the label." })), "name": Schema.optionalKey(Schema.String.annotate({ "description": "Name of the label." })), "prefix": Schema.optionalKey(Schema.String.annotate({ "description": "Prefix of the label." })) }).annotate({ "identifier": "Label" })
export type OptionalFieldMeta = { readonly "hasMore"?: boolean, readonly "cursor"?: string }
export const OptionalFieldMeta = Schema.Struct({ "hasMore": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Indicates if there are more available results that can be fetched." })), "cursor": Schema.optionalKey(Schema.String.annotate({ "description": "A token that can be used in the query parameter of the endpoint returned in the `_links` property to retrieve the next set of results." })) }).annotate({ "identifier": "OptionalFieldMeta" })
export type OptionalFieldLinks = { readonly "self"?: string }
export const OptionalFieldLinks = Schema.Struct({ "self": Schema.optionalKey(Schema.String.annotate({ "description": "A relative URL that can be used to fetch results beyond what this include parameter retrieves." })) }).annotate({ "identifier": "OptionalFieldLinks" })
export type Operation = { readonly "operation"?: string, readonly "targetType"?: string }
export const Operation = Schema.Struct({ "operation": Schema.optionalKey(Schema.String.annotate({ "description": "The type of operation." })), "targetType": Schema.optionalKey(Schema.String.annotate({ "description": "The type of entity the operation type targets." })) }).annotate({ "identifier": "Operation" })
export type ContentPropertySortOrder = "key" | "-key"
export const ContentPropertySortOrder = Schema.Literals(["key", "-key"]).annotate({ "description": "The sort fields for content properties. The default sort direction is ascending. To sort in descending order, append a `-` character before the sort field. For example, `fieldName` or `-fieldName`.", "identifier": "ContentPropertySortOrder" })
export type ContentPropertyCreateRequest = { readonly "key"?: string, readonly "value"?: Schema.Json }
export const ContentPropertyCreateRequest = Schema.Struct({ "key": Schema.optionalKey(Schema.String.annotate({ "description": "Key of the content property" })), "value": Schema.optionalKey(Schema.Json.annotate({ "expected": "JSON value", "description": "Value of the content property." })) }).annotate({ "identifier": "ContentPropertyCreateRequest" })
...
export const ContentPropertyUpdateRequest = Schema.Struct({ "key": Schema.optionalKey(Schema.String.annotate({ "description": "Key of the content property" })), "value": Schema.optionalKey(Schema.Json.annotate({ "expected": "JSON value", "description": "Value of the content property." })), "version": Schema.optionalKey(Schema.Struct({ "number": Schema.optionalKey(Schema.Number.annotate({ "description": "Version number of the new version. Should be 1 more than the current version number.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Message to be associated with the new version." })) }).annotate({ "description": "New version number and associated message" })) }).annotate({ "identifier": "ContentPropertyUpdateRequest" })
export type VersionSortOrder = "modified-date" | "-modified-date"
export const VersionSortOrder = Schema.Literals(["modified-date", "-modified-date"]).annotate({ "description": "The sort fields for versions. The default sort direction is ascending. To sort in descending order, append a `-` character before the sort field. For example, `fieldName` or `-fieldName`.", "identifier": "VersionSortOrder" })
export type BodyType = { readonly "representation"?: string, readonly "value"?: string }
export const BodyType = Schema.Struct({ "representation": Schema.optionalKey(Schema.String.annotate({ "description": "Type of content representation used for the value field." })), "value": Schema.optionalKey(Schema.String.annotate({ "description": "Body of the content, in the format found in the representation field." })) }).annotate({ "identifier": "BodyType" })
...
export const Like = Schema.Struct({ "accountId": Schema.optionalKey(Schema.String.annotate({ "description": "Account ID." })) }).annotate({ "identifier": "Like" })
...
export const CustomContentBodyRepresentationSingle = Schema.Literals(["raw", "storage", "atlas_doc_format", "view", "export_view", "anonymous_export_view"]).annotate({ "description": "The formats a custom content body can be represented as. A subset of BodyRepresentation.", "identifier": "CustomContentBodyRepresentationSingle" })
export type PageSortOrder = "id" | "-id" | "created-date" | "-created-date" | "modified-date" | "-modified-date" | "title" | "-title"
export const PageSortOrder = Schema.Literals(["id", "-id", "created-date", "-created-date", "modified-date", "-modified-date", "title", "-title"]).annotate({ "description": "The sort fields for pages. The default sort direction is ascending. To sort in descending order, append a `-` character before the sort field. For example, `fieldName` or `-fieldName`.", "identifier": "PageSortOrder" })
export type ParentContentType = "page" | "whiteboard" | "database" | "embed" | "folder"
export const ParentContentType = Schema.Literals(["page", "whiteboard", "database", "embed", "folder"]).annotate({ "description": "Content type of the parent, or null if there is no parent.", "identifier": "ParentContentType" })
...
export const RedactionPointer = Schema.Struct({ "pointer": Schema.String.annotate({ "description": "JSON pointer indicating the exact location within the content structure \nwhere redaction should be applied. Points to the text node containing the content to redact.\n" }), "from": Schema.optionalKey(Schema.Number.annotate({ "description": "Starting character index (zero-based) within the target text where redaction begins.\n" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "to": Schema.optionalKey(Schema.Number.annotate({ "description": "Ending character index (zero-based) within the target text where redaction ends (exclusive).\nMust be greater than or equal to 'from' value.\n" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))), "reason": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Optional human-readable reason for the redaction. Used for audit trails and compliance documentation.\n" })) }).annotate({ "identifier": "RedactionPointer" })
...
export const RedactionPointerResponse = Schema.Struct({ "pointer": Schema.optionalKey(Schema.String.annotate({ "description": "JSON pointer indicating where the redaction was applied" })), "from": Schema.optionalKey(Schema.Number.annotate({ "description": "Starting character index where redaction was applied" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "to": Schema.optionalKey(Schema.Number.annotate({ "description": "Ending character index where redaction was applied" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "reason": Schema.optionalKey(Schema.String.annotate({ "description": "Reason for the redaction" })), "redactionId": Schema.optionalKey(Schema.String.annotate({ "description": "Unique identifier for this redaction. Can be used to restore the redacted content later.\n", "format": "uuid" })) }).annotate({ "identifier": "RedactionPointerResponse" })
export type OnlyArchivedAndCurrentContentStatus = "current" | "archived"
export const OnlyArchivedAndCurrentContentStatus = Schema.Literals(["current", "archived"]).annotate({ "description": "The status of the content.", "identifier": "OnlyArchivedAndCurrentContentStatus" })
export type AncestorType = "page" | "whiteboard" | "database" | "embed" | "folder"
export const AncestorType = Schema.Literals(["page", "whiteboard", "database", "embed", "folder"]).annotate({ "description": "The type of ancestor.", "identifier": "AncestorType" })
export type SpaceSortOrder = "id" | "-id" | "key" | "-key" | "name" | "-name"
export const SpaceSortOrder = Schema.Literals(["id", "-id", "key", "-key", "name", "-name"]).annotate({ "description": "The sort fields for spaces. The default sort direction is ascending. To sort in descending order, append a `-` character before the sort field. For example, `fieldName` or `-fieldName`.", "identifier": "SpaceSortOrder" })
export type SpaceDescriptionBodyRepresentation = "plain" | "view"
export const SpaceDescriptionBodyRepresentation = Schema.Literals(["plain", "view"]).annotate({ "description": "The formats a space description can be represented as. A subset of BodyRepresentation.", "identifier": "SpaceDescriptionBodyRepresentation" })
export type SpaceType = "global" | "collaboration" | "knowledge_base" | "personal" | "system" | "onboarding" | "xflow_sample_space"
export const SpaceType = Schema.Literals(["global", "collaboration", "knowledge_base", "personal", "system", "onboarding", "xflow_sample_space"]).annotate({ "description": "The type of space.", "identifier": "SpaceType" })
export type SpaceStatus = "current" | "archived" | "trashed"
export const SpaceStatus = Schema.Literals(["current", "archived", "trashed"]).annotate({ "description": "The status of the space.", "identifier": "SpaceStatus" })
export type SpaceIcon = { readonly "path"?: string, readonly "apiDownloadLink"?: string }
export const SpaceIcon = Schema.Struct({ "path": Schema.optionalKey(Schema.String.annotate({ "description": "The path (relative to base URL) at which the space's icon can be retrieved. The format should be like `/wiki/download/...` or `/wiki/aa-avatar/...`" })), "apiDownloadLink": Schema.optionalKey(Schema.String.annotate({ "description": "The path (relative to base URL) that can be used to retrieve a link to download the space icon. 3LO apps should use this link instead of the value provided\nin the `path` property to retrieve the icon.\n\nCurrently this field is only returned for `global` spaces and not `personal` spaces.\n" })) }).annotate({ "description": "The icon of the space", "identifier": "SpaceIcon" })
export type SpaceLinks = { readonly "webui"?: string }
export const SpaceLinks = Schema.Struct({ "webui": Schema.optionalKey(Schema.String.annotate({ "description": "Web UI link of the space." })) }).annotate({ "identifier": "SpaceLinks" })
export type PrincipalType = "USER" | "GROUP" | "ACCESS_CLASS"
export const PrincipalType = Schema.Literals(["USER", "GROUP", "ACCESS_CLASS"]).annotate({ "description": "The principal type.", "identifier": "PrincipalType" })
...
export const SpacePropertyUpdateRequest = Schema.Struct({ "key": Schema.optionalKey(Schema.String.annotate({ "description": "Key of the space property" })), "value": Schema.optionalKey(Schema.Json.annotate({ "expected": "JSON value", "description": "Value of the space property." })), "version": Schema.optionalKey(Schema.Struct({ "number": Schema.optionalKey(Schema.Number.annotate({ "description": "Version number of the new version. Should be 1 more than the current version number.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Message to be associated with the new version." })) }).annotate({ "description": "New version number and associated message" })) }).annotate({ "identifier": "SpacePropertyUpdateRequest" })
...
export const BulkTransitionTaskResponse = Schema.Struct({ "taskId": Schema.String.annotate({ "description": "The ID of the async task." }), "status": Schema.Literals(["IN_PROGRESS", "COMPLETED", "FAILED"]).annotate({ "description": "The current status of the task." }), "statusUrl": Schema.String.annotate({ "description": "URL to poll for task progress." }) }).annotate({ "identifier": "BulkTransitionTaskResponse" })
...
export const BulkTransitionPrincipalTypeAssignment = Schema.Struct({ "principalType": Schema.Literals(["USER", "GROUP", "GUEST", "ANONYMOUS", "ALL_LICENSED_USERS_USER_CLASS", "ALL_PRODUCT_ADMINS_USER_CLASS", "APP"]).annotate({ "description": "The type of principal." }), "removeAccess": Schema.Boolean.annotate({ "description": "Whether to remove access for this principal type instead of assigning a role." }), "roleId": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "The UUID of the space role to assign. Required when removeAccess is false." })) }).annotate({ "identifier": "BulkTransitionPrincipalTypeAssignment" })
export type BulkTransitionSpaceTarget = { readonly "id": string, readonly "key": string }
export const BulkTransitionSpaceTarget = Schema.Struct({ "id": Schema.String.annotate({ "description": "The space ID." }), "key": Schema.String.annotate({ "description": "The space key." }) }).annotate({ "identifier": "BulkTransitionSpaceTarget" })
...
export const BulkTransitionTaskStatusResponse = Schema.Struct({ "taskId": Schema.String.annotate({ "description": "The ID of the task." }), "status": Schema.Literals(["IN_PROGRESS", "COMPLETED", "FAILED"]).annotate({ "description": "The current status of the task." }), "errorMessage": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Human-readable error message describing why the task failed. Only present when status is FAILED." })) }).annotate({ "identifier": "BulkTransitionTaskStatusResponse" })
export type RoleType = "SYSTEM" | "CUSTOM"
export const RoleType = Schema.Literals(["SYSTEM", "CUSTOM"]).annotate({ "description": "The role type.", "identifier": "RoleType" })
export type DeleteSpaceRoleResponse = { readonly "taskId"?: string }
export const DeleteSpaceRoleResponse = Schema.Struct({ "taskId": Schema.optionalKey(Schema.String.annotate({ "description": "Id of the task to update the space permissions associated with the space role" })) }).annotate({ "identifier": "DeleteSpaceRoleResponse" })
export type InlineCommentResolutionStatus = "open" | "reopened" | "resolved" | "dangling"
export const InlineCommentResolutionStatus = Schema.Literals(["open", "reopened", "resolved", "dangling"]).annotate({ "description": "Inline comment resolution status", "identifier": "InlineCommentResolutionStatus" })
export type InlineCommentProperties = { readonly "inlineMarkerRef"?: string, readonly "inlineOriginalSelection"?: string }
export const InlineCommentProperties = Schema.Struct({ "inlineMarkerRef": Schema.optionalKey(Schema.String.annotate({ "description": "Property value used to reference the highlighted element in DOM." })), "inlineOriginalSelection": Schema.optionalKey(Schema.String.annotate({ "description": "Text that is highlighted." })) }).annotate({ "identifier": "InlineCommentProperties" })
...
export const AccountStatus = Schema.Literals(["active", "inactive", "closed", "unknown"]).annotate({ "description": "The account status of the user.", "identifier": "AccountStatus" })
export type AccountType = "atlassian" | "app" | "customer" | "unknown"
export const AccountType = Schema.Literals(["atlassian", "app", "customer", "unknown"]).annotate({ "description": "The account type of the user.", "identifier": "AccountType" })
export type Icon = { readonly "path": string, readonly "isDefault": boolean, readonly [x: string]: Schema.Json } | null
export const Icon = Schema.Union([Schema.StructWithRest(Schema.Struct({ "path": Schema.String, "isDefault": Schema.Boolean }), [Schema.Record(Schema.String, Schema.Json.annotate({ "expected": "JSON value" }))]), Schema.Null]).annotate({ "description": "This object represents an icon. If used as a profilePicture, this may be returned as null, depending on the user's privacy setting.", "identifier": "Icon" })
export type DataPolicyMetadata = { readonly "anyContentBlocked"?: boolean }
export const DataPolicyMetadata = Schema.Struct({ "anyContentBlocked": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Whether the workspace contains any content blocked for (inaccessible to) the requesting client application.", "readOnly": true })) }).annotate({ "description": "Details about data policies.", "identifier": "DataPolicyMetadata" })
export type ClassificationLevel = { readonly "id"?: string, readonly "status"?: never, readonly "order"?: number, readonly "name"?: string, readonly "description"?: string, readonly "guideline"?: string, readonly "color"?: never }
export const ClassificationLevel = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "The ID of the classification level." })), "status": Schema.optionalKey(Schema.Never.annotate({ "description": "The status of the classification level." })), "order": Schema.optionalKey(Schema.Number.annotate({ "description": "The order of the classification level object." }).check(Schema.isFinite().annotate({ "expected": "a finite number" }))), "name": Schema.optionalKey(Schema.String.annotate({ "description": "The name of the classification level object." })), "description": Schema.optionalKey(Schema.String.annotate({ "description": "The description of the classification level object." })), "guideline": Schema.optionalKey(Schema.String.annotate({ "description": "The guideline of the classification level object." })), "color": Schema.optionalKey(Schema.Never.annotate({ "description": "The color of the classification level object." })) }).annotate({ "title": "ClassificationLevel", "description": "A unit of [data classification](https://support.atlassian.com/security-and-access-policies/docs/what-is-data-classification/) defined by an organiation. \nA classification level may be associated with specific storage and handling requirements or expectations.", "identifier": "ClassificationLevel" })
export type ContentProperty = { readonly "id"?: string, readonly "key"?: string, readonly "value"?: Schema.Json, readonly "version"?: Version }
export const ContentProperty = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the property" })), "key": Schema.optionalKey(Schema.String.annotate({ "description": "Key of the property" })), "value": Schema.optionalKey(Schema.Json.annotate({ "expected": "JSON value", "description": "Value of the property. Must be a valid JSON value." })), "version": Schema.optionalKey(Version) }).annotate({ "identifier": "ContentProperty" })
export type AttachmentBulk = { readonly "id"?: string, readonly "status"?: ContentStatus, readonly "title"?: string, readonly "createdAt"?: string, readonly "pageId"?: string, readonly "blogPostId"?: string, readonly "customContentId"?: string, readonly "mediaType"?: string, readonly "mediaTypeDescription"?: string | null, readonly "comment"?: string, readonly "fileId"?: string, readonly "fileSize"?: number, readonly "webuiLink"?: string, readonly "downloadLink"?: string, readonly "version"?: Version, readonly "_links"?: AttachmentLinks }
export const AttachmentBulk = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the attachment." })), "status": Schema.optionalKey(ContentStatus), "title": Schema.optionalKey(Schema.String.annotate({ "description": "Title of the comment." })), "createdAt": Schema.optionalKey(Schema.String.annotate({ "description": "Date and time when the attachment was created. In format \"YYYY-MM-DDTHH:mm:ss.sssZ\".", "format": "date-time" })), "pageId": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the containing page.\n\nNote: This is only returned if the attachment has a container that is a page." })), "blogPostId": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the containing blog post.\n\nNote: This is only returned if the attachment has a container that is a blog post." })), "customContentId": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the containing custom content.\n\nNote: This is only returned if the attachment has a container that is custom content." })), "mediaType": Schema.optionalKey(Schema.String.annotate({ "description": "Media Type for the attachment." })), "mediaTypeDescription": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Media Type description for the attachment. Atlassian may return null." })), "comment": Schema.optionalKey(Schema.String.annotate({ "description": "Comment for the attachment." })), "fileId": Schema.optionalKey(Schema.String.annotate({ "description": "File ID of the attachment. This is the ID referenced in `atlas_doc_format` bodies and is distinct from the attachment ID." })), "fileSize": Schema.optionalKey(Schema.Number.annotate({ "description": "File size of the attachment.", "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "webuiLink": Schema.optionalKey(Schema.String.annotate({ "description": "WebUI link of the attachment." })), "downloadLink": Schema.optionalKey(Schema.String.annotate({ "description": "Download link of the attachment." })), "version": Schema.optionalKey(Version), "_links": Schema.optionalKey(AttachmentLinks) }).annotate({ "identifier": "AttachmentBulk" })
export type PermittedOperationsResponse = { readonly "operations"?: ReadonlyArray<Operation> }
export const PermittedOperationsResponse = Schema.Struct({ "operations": Schema.optionalKey(Schema.Array(Operation)) }).annotate({ "description": "The list of operations permitted on entity.", "identifier": "PermittedOperationsResponse" })
export type BodyBulk = { readonly "storage"?: BodyType, readonly "atlas_doc_format"?: BodyType }
export const BodyBulk = Schema.Struct({ "storage": Schema.optionalKey(BodyType), "atlas_doc_format": Schema.optionalKey(BodyType) }).annotate({ "description": "Contains fields for each representation type requested.", "identifier": "BodyBulk" })
export type BodySingle = { readonly "storage"?: BodyType, readonly "atlas_doc_format"?: BodyType, readonly "view"?: BodyType }
export const BodySingle = Schema.Struct({ "storage": Schema.optionalKey(BodyType), "atlas_doc_format": Schema.optionalKey(BodyType), "view": Schema.optionalKey(BodyType) }).annotate({ "description": "Contains fields for each representation type requested.", "identifier": "BodySingle" })
export type CustomContentBodyBulk = { readonly "raw"?: BodyType, readonly "storage"?: BodyType, readonly "atlas_doc_format"?: BodyType }
export const CustomContentBodyBulk = Schema.Struct({ "raw": Schema.optionalKey(BodyType), "storage": Schema.optionalKey(BodyType), "atlas_doc_format": Schema.optionalKey(BodyType) }).annotate({ "description": "Contains fields for each representation type requested.", "identifier": "CustomContentBodyBulk" })
...
export const CustomContentBodySingle = Schema.Struct({ "raw": Schema.optionalKey(BodyType), "storage": Schema.optionalKey(BodyType), "atlas_doc_format": Schema.optionalKey(BodyType), "view": Schema.optionalKey(BodyType) }).annotate({ "description": "Contains fields for each representation type requested.", "identifier": "CustomContentBodySingle" })
export type SpaceDescription = { readonly "plain"?: BodyType, readonly "view"?: BodyType }
export const SpaceDescription = Schema.Struct({ "plain": Schema.optionalKey(BodyType), "view": Schema.optionalKey(BodyType) }).annotate({ "description": "Contains fields for each representation type requested.", "identifier": "SpaceDescription" })
export type TaskBodySingle = { readonly "storage"?: BodyType, readonly "atlas_doc_format"?: BodyType }
export const TaskBodySingle = Schema.Struct({ "storage": Schema.optionalKey(BodyType), "atlas_doc_format": Schema.optionalKey(BodyType) }).annotate({ "description": "Contains fields for each representation type requested.", "identifier": "TaskBodySingle" })
...
export const PageNestedBodyWrite = Schema.Struct({ "storage": Schema.optionalKey(PageBodyWrite), "atlas_doc_format": Schema.optionalKey(PageBodyWrite), "wiki": Schema.optionalKey(PageBodyWrite) }).annotate({ "description": "Body of the page. Only one body format should be specified as the property\nfor this object, e.g. `storage`.", "identifier": "PageNestedBodyWrite" })
export type RedactionSectionResponse = { readonly "redactions"?: ReadonlyArray<RedactionPointerResponse> }
export const RedactionSectionResponse = Schema.Struct({ "redactions": Schema.optionalKey(Schema.Array(RedactionPointerResponse).annotate({ "description": "List of redactions that were applied to this section" })) }).annotate({ "identifier": "RedactionSectionResponse" })
export type ChildrenResponse = { readonly "id"?: string, readonly "status"?: OnlyArchivedAndCurrentContentStatus, readonly "title"?: string, readonly "type"?: string, readonly "spaceId"?: string, readonly "childPosition"?: number | null }
export const ChildrenResponse = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the child content." })), "status": Schema.optionalKey(OnlyArchivedAndCurrentContentStatus), "title": Schema.optionalKey(Schema.String.annotate({ "description": "Title of the child content." })), "type": Schema.optionalKey(Schema.String.annotate({ "description": "Hierarchical content type (database/embed/folder/page/whiteboard)." })), "spaceId": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the space the content is in." })), "childPosition": Schema.optionalKey(Schema.Union([Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })), Schema.Null]).annotate({ "description": "Position of the child within its parent content tree." })) }).annotate({ "identifier": "ChildrenResponse" })
export type DescendantsResponse = { readonly "id"?: string, readonly "status"?: OnlyArchivedAndCurrentContentStatus, readonly "title"?: string, readonly "type"?: string, readonly "parentId"?: string, readonly "depth"?: number, readonly "childPosition"?: number | null }
export const DescendantsResponse = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the descendant." })), "status": Schema.optionalKey(OnlyArchivedAndCurrentContentStatus), "title": Schema.optionalKey(Schema.String.annotate({ "description": "Title of the descendant." })), "type": Schema.optionalKey(Schema.String.annotate({ "description": "Hierarchical content type (database/embed/folder/page/whiteboard)." })), "parentId": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the parent content." })), "depth": Schema.optionalKey(Schema.Number.annotate({ "description": "Depth of the descendant in the content tree relative to the content specified in the request.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "childPosition": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" })), Schema.Null]).annotate({ "description": "Numerical value indicating position of the content relative to its siblings (with the same parentId) within the content tree.\nIf the content is sorted by childPosition, it will reflect the default content ordering within the content tree.", "format": "int32" })) }).annotate({ "identifier": "DescendantsResponse" })
...
export const Ancestor = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the ancestor" })), "type": Schema.optionalKey(AncestorType) }).annotate({ "identifier": "Ancestor" })
export type Principal = { readonly "principalType"?: PrincipalType, readonly "principalId"?: string }
export const Principal = Schema.Struct({ "principalType": Schema.optionalKey(PrincipalType), "principalId": Schema.optionalKey(Schema.String.annotate({ "description": "The principal ID." })) }).annotate({ "description": "The principal of the role assignment.", "identifier": "Principal" })
...
export const BulkTransitionCombinationEntry = Schema.Struct({ "combinationId": Schema.String.annotate({ "description": "The opaque id identifying this unique combination of space permissions. Pass directly to the bulk role-assignments or access-removals endpoints." }), "spaceCount": Schema.Number.annotate({ "description": "Number of spaces that currently have this combination.", "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" })), "principalCount": Schema.Number.annotate({ "description": "Number of principals (users / groups / etc.) that currently have this combination.", "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" })), "permissions": Schema.Array(BulkTransitionDecodedPermission).annotate({ "description": "The decoded space permissions that make up this combination." }), "principalTypes": Schema.Array(Schema.Literals(["USER", "GROUP", "GUEST", "ANONYMOUS", "ALL_LICENSED_USERS_USER_CLASS", "ALL_PRODUCT_ADMINS_USER_CLASS", "APP", "TEAM"])).annotate({ "description": "The principal types that currently hold this combination and can be reassigned via the\nbulk role-assignments endpoint. Use this to know which `principalType` entries are valid\nto include in the bulk-assign request for this combination." }) }).annotate({ "identifier": "BulkTransitionCombinationEntry" })
...
export const BulkTransitionRoleAssignment = Schema.Struct({ "permissionCombinationId": Schema.String.annotate({ "description": "The ID of the permission combination." }), "principalTypeAssignments": Schema.Array(BulkTransitionPrincipalTypeAssignment).annotate({ "description": "List of principal type assignments." }) }).annotate({ "identifier": "BulkTransitionRoleAssignment" })
...
export const BulkTransitionSpaceSelection = Schema.Struct({ "spaceType": Schema.Literals(["ALL", "ALL_EXCEPT_PERSONAL", "ALL_EXCEPT_SPECIFIC", "PERSONAL", "SPECIFIC"]).annotate({ "description": "The space selection type." }), "selectedSpaces": Schema.optionalKey(Schema.Array(BulkTransitionSpaceTarget).annotate({ "description": "List of specific spaces. Required when spaceType is SPECIFIC or ALL_EXCEPT_SPECIFIC." })) }).annotate({ "identifier": "BulkTransitionSpaceSelection" })
...
export const AttachmentCommentModel = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the comment." })), "status": Schema.optionalKey(ContentStatus), "title": Schema.optionalKey(Schema.String.annotate({ "description": "Title of the comment." })), "attachmentId": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the attachment containing the comment." })), "version": Schema.optionalKey(Version), "body": Schema.optionalKey(BodySingle), "_links": Schema.optionalKey(CommentLinks) }).annotate({ "identifier": "AttachmentCommentModel" })
...
export const BulkAssignRolesRequest = Schema.Struct({ "assignments": Schema.Array(BulkTransitionRoleAssignment).annotate({ "description": "List of role assignments to apply." }), "spaceSelection": BulkTransitionSpaceSelection }).annotate({ "identifier": "BulkAssignRolesRequest" })
...
export const BulkRemoveAccessRequest = Schema.Struct({ "permissionCombinationIds": Schema.Array(Schema.String).annotate({ "description": "List of permission combination IDs to remove access for." }), "spaceSelection": BulkTransitionSpaceSelection }).annotate({ "identifier": "BulkRemoveAccessRequest" })
...
export const UpdateInlineCommentModel = Schema.Struct({ "version": Schema.optionalKey(Schema.Struct({ "number": Schema.optionalKey(Schema.Number.annotate({ "description": "Number of new version. Should be 1 higher than current version of the comment." }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Optional message store for the new version." })) })), "body": Schema.optionalKey(Schema.Union([CommentBodyWrite, CommentNestedBodyWrite], { mode: "oneOf" })), "resolved": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Resolved state of the comment. Set to true to resolve the comment, set to false to reopen it. If\nmatching the existing state (i.e. true -> resolved or false -> open/reopened) , no change will occur. A dangling\ncomment cannot be updated." })) }).annotate({ "identifier": "UpdateInlineCommentModel" })
...
export const AttachmentVersion = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "description": "Date and time when the version was created. In format \"YYYY-MM-DDTHH:mm:ss.sssZ\".", "format": "date-time" })), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Message associated with the current version." })), "number": Schema.optionalKey(Schema.Number.annotate({ "description": "The version number.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "minorEdit": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Describes if this version is a minor version. Email notifications and activity stream updates are not created for minor versions." })), "authorId": Schema.optionalKey(Schema.String.annotate({ "description": "The account ID of the user who created this version." })), "attachment": Schema.optionalKey(VersionedEntity) }).annotate({ "identifier": "AttachmentVersion" })
...
export const PageVersion = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "description": "Date and time when the version was created. In format \"YYYY-MM-DDTHH:mm:ss.sssZ\".", "format": "date-time" })), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Message associated with the current version." })), "number": Schema.optionalKey(Schema.Number.annotate({ "description": "The version number.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "minorEdit": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Describes if this version is a minor version. Email notifications and activity stream updates are not created for minor versions." })), "authorId": Schema.optionalKey(Schema.String.annotate({ "description": "The account ID of the user who created this version." })), "page": Schema.optionalKey(VersionedEntity) }).annotate({ "identifier": "PageVersion" })
...
export const CustomContentVersion = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "description": "Date and time when the version was created. In format \"YYYY-MM-DDTHH:mm:ss.sssZ\".", "format": "date-time" })), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Message associated with the current version." })), "number": Schema.optionalKey(Schema.Number.annotate({ "description": "The version number.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "minorEdit": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Describes if this version is a minor version. Email notifications and activity stream updates are not created for minor versions." })), "authorId": Schema.optionalKey(Schema.String.annotate({ "description": "The account ID of the user who created this version." })), "custom": Schema.optionalKey(VersionedEntity) }).annotate({ "identifier": "CustomContentVersion" })
...
export const CommentVersion = Schema.Struct({ "createdAt": Schema.optionalKey(Schema.String.annotate({ "description": "Date and time when the version was created. In format \"YYYY-MM-DDTHH:mm:ss.sssZ\".", "format": "date-time" })), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Message associated with the current version." })), "number": Schema.optionalKey(Schema.Number.annotate({ "description": "The version number.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "minorEdit": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Describes if this version is a minor version. Email notifications and activity stream updates are not created for minor versions." })), "authorId": Schema.optionalKey(Schema.String.annotate({ "description": "The account ID of the user who created this version." })), "comment": Schema.optionalKey(VersionedEntity) }).annotate({ "identifier": "CommentVersion" })
// schemas
...
export const EnableAdminKeyRequestJson = Schema.Struct({ "durationInMinutes": Schema.optionalKey(Schema.Number.annotate({ "description": "The requested duration of admin key access in minutes, up to a maximum of 60 minutes, after which the issued admin key will automatically expire.", "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) })
...
export const GetAttachmentsParams = Schema.Struct({ "sort": Schema.optionalKey(AttachmentSortOrder), "cursor": Schema.optionalKey(Schema.String), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "trashed"]))), "mediaType": Schema.optionalKey(Schema.String), "filename": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetAttachmentByIdParams = Schema.Struct({ "version": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "include-labels": Schema.optionalKey(Schema.Boolean), "include-properties": Schema.optionalKey(Schema.Boolean), "include-operations": Schema.optionalKey(Schema.Boolean), "include-versions": Schema.optionalKey(Schema.Boolean), "include-version": Schema.optionalKey(Schema.Boolean), "include-collaborators": Schema.optionalKey(Schema.Boolean) })
export type GetAttachmentById200 = { readonly "id"?: string, readonly "status"?: ContentStatus, readonly "title"?: string, readonly "createdAt"?: string, readonly "pageId"?: string, readonly "blogPostId"?: string, readonly "customContentId"?: string, readonly "mediaType"?: string, readonly "mediaTypeDescription"?: string | null, readonly "comment"?: string, readonly "fileId"?: string, readonly "fileSize"?: number, readonly "webuiLink"?: string, readonly "downloadLink"?: string, readonly "version"?: Version, readonly "labels"?: { readonly "results"?: ReadonlyArray<Label>, readonly "meta"?: OptionalFieldMeta, readonly "_links"?: OptionalFieldLinks }, readonly "properties"?: { readonly "results"?: ReadonlyArray<ContentProperty>, readonly "meta"?: OptionalFieldMeta, readonly "_links"?: OptionalFieldLinks }, readonly "operations"?: { readonly "results"?: ReadonlyArray<Operation>, readonly "meta"?: OptionalFieldMeta, readonly "_links"?: OptionalFieldLinks }, readonly "versions"?: { readonly "results"?: ReadonlyArray<Version>, readonly "meta"?: OptionalFieldMeta, readonly "_links"?: OptionalFieldLinks }, readonly "_links"?: { readonly "webui"?: string, readonly "download"?: string, readonly "base"?: string } }
...
export const GetAttachmentLabelsParams = Schema.Struct({ "prefix": Schema.optionalKey(Schema.Literals(["my", "team", "global", "system"])), "sort": Schema.optionalKey(Schema.String), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetAttachmentContentPropertiesParams = Schema.Struct({ "key": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(ContentPropertySortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetAttachmentVersionsParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(VersionSortOrder) })
...
export const GetAttachmentCommentsParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(CommentSortOrder), "version": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) })
...
export const GetBlogPostsParams = Schema.Struct({ "id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "space-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" }))), "sort": Schema.optionalKey(BlogPostSortOrder), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "deleted", "trashed"]))), "title": Schema.optionalKey(Schema.String), "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetBlogPostByIdParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentationSingle), "get-draft": Schema.optionalKey(Schema.Boolean), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "trashed", "deleted", "historical", "draft"]))), "version": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "include-labels": Schema.optionalKey(Schema.Boolean), "include-properties": Schema.optionalKey(Schema.Boolean), "include-operations": Schema.optionalKey(Schema.Boolean), "include-likes": Schema.optionalKey(Schema.Boolean), "include-versions": Schema.optionalKey(Schema.Boolean), "include-version": Schema.optionalKey(Schema.Boolean), "include-favorited-by-current-user-status": Schema.optionalKey(Schema.Boolean), "include-webresources": Schema.optionalKey(Schema.Boolean), "include-collaborators": Schema.optionalKey(Schema.Boolean) })
...
export const GetBlogpostAttachmentsParams = Schema.Struct({ "sort": Schema.optionalKey(AttachmentSortOrder), "cursor": Schema.optionalKey(Schema.String), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "trashed"]))), "mediaType": Schema.optionalKey(Schema.String), "filename": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetCustomContentByTypeInBlogPostParams = Schema.Struct({ "type": Schema.String, "sort": Schema.optionalKey(CustomContentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "body-format": Schema.optionalKey(CustomContentBodyRepresentation) })
...
export const GetBlogPostLikeCount200 = Schema.Struct({ "count": Schema.optionalKey(Schema.Number.annotate({ "description": "The count number", "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) }).annotate({ "title": "Integer" })
export type GetBlogPostLikeUsersParams = { readonly "cursor"?: string, readonly "limit"?: number }
export const GetBlogPostLikeUsersParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const ConvertContentIdsToContentTypesRequestJson = Schema.Struct({ "contentIds": Schema.Array(Schema.Union([Schema.String, Schema.Number.check(Schema.isFinite().annotate({ "expected": "a finite number" }))])).annotate({ "description": "The content ids to convert. They may be provided as strings or numbers." }).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" })) })
...
export const GetCustomContentByTypeParams = Schema.Struct({ "type": Schema.String, "id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "space-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" }))), "sort": Schema.optionalKey(CustomContentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "body-format": Schema.optionalKey(CustomContentBodyRepresentation) })
...
export const GetCustomContentByIdParams = Schema.Struct({ "body-format": Schema.optionalKey(CustomContentBodyRepresentationSingle), "version": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "include-labels": Schema.optionalKey(Schema.Boolean), "include-properties": Schema.optionalKey(Schema.Boolean), "include-operations": Schema.optionalKey(Schema.Boolean), "include-versions": Schema.optionalKey(Schema.Boolean), "include-version": Schema.optionalKey(Schema.Boolean), "include-collaborators": Schema.optionalKey(Schema.Boolean) })
...
export const GetCustomContentAttachmentsParams = Schema.Struct({ "sort": Schema.optionalKey(AttachmentSortOrder), "cursor": Schema.optionalKey(Schema.String), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "trashed"]))), "mediaType": Schema.optionalKey(Schema.String), "filename": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetCustomContentCommentsParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(CommentSortOrder) })
...
export const GetCustomContentContentPropertiesParams = Schema.Struct({ "key": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(ContentPropertySortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetLabelsParams = Schema.Struct({ "label-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" })))), "prefix": Schema.optionalKey(Schema.Array(Schema.String)), "cursor": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetLabelAttachmentsParams = Schema.Struct({ "sort": Schema.optionalKey(AttachmentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetLabelBlogPostsParams = Schema.Struct({ "space-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" }))), "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "sort": Schema.optionalKey(BlogPostSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetLabelPagesParams = Schema.Struct({ "space-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" }))), "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "sort": Schema.optionalKey(PageSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetPagesParams = Schema.Struct({ "id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "space-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" }))), "sort": Schema.optionalKey(PageSortOrder), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "deleted", "trashed"]))), "title": Schema.optionalKey(Schema.String), "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "subtype": Schema.optionalKey(Schema.Literals(["live", "page"])), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetPageByIdParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentationSingle), "get-draft": Schema.optionalKey(Schema.Boolean), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "trashed", "deleted", "historical", "draft"]))), "version": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "include-labels": Schema.optionalKey(Schema.Boolean), "include-properties": Schema.optionalKey(Schema.Boolean), "include-operations": Schema.optionalKey(Schema.Boolean), "include-likes": Schema.optionalKey(Schema.Boolean), "include-versions": Schema.optionalKey(Schema.Boolean), "include-version": Schema.optionalKey(Schema.Boolean), "include-favorited-by-current-user-status": Schema.optionalKey(Schema.Boolean), "include-webresources": Schema.optionalKey(Schema.Boolean), "include-collaborators": Schema.optionalKey(Schema.Boolean), "include-direct-children": Schema.optionalKey(Schema.Boolean) })
...
export const GetPageAttachmentsParams = Schema.Struct({ "sort": Schema.optionalKey(AttachmentSortOrder), "cursor": Schema.optionalKey(Schema.String), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "trashed"]))), "mediaType": Schema.optionalKey(Schema.String), "filename": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetCustomContentByTypeInPageParams = Schema.Struct({ "type": Schema.String, "sort": Schema.optionalKey(CustomContentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "body-format": Schema.optionalKey(CustomContentBodyRepresentation) })
...
export const GetPageLikeCount200 = Schema.Struct({ "count": Schema.optionalKey(Schema.Number.annotate({ "description": "The count number", "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) }).annotate({ "title": "Integer" })
export type GetPageLikeUsersParams = { readonly "cursor"?: string, readonly "limit"?: number }
export const GetPageLikeUsersParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export type PostRedactPageRequestJson = { readonly "createdAt": string, readonly "cleanHistory"?: boolean | null, readonly "versionNumber"?: number | null, readonly "body"?: { readonly "redactions"?: ReadonlyArray<RedactionPointer> }, readonly "title"?: { readonly "redactions"?: ReadonlyArray<RedactionPointer> } }
export const PostRedactPageRequestJson = Schema.Struct({ "createdAt": Schema.String.annotate({ "description": "Timestamp when the content was last updated.", "format": "date-time" }), "cleanHistory": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null]).annotate({ "description": "Whether to clean up previous versions containing the redaction. When true, historical versions of the content that contain the redacted text will be squashed." })), "versionNumber": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })), Schema.Null]).annotate({ "description": "Optional version number of the content to redact. When specified, the redaction will target \na specific historical version of the content rather than the current version.\n\n- If omitted or null, the redaction applies to the current (latest) version of the content.\n- When provided, must be a valid version number that exists for the content.\n\n**Note**: Version numbers start at 1 and increment with each content update.\n", "format": "int32" })), "body": Schema.optionalKey(Schema.Struct({ "redactions": Schema.optionalKey(Schema.Array(RedactionPointer)) })), "title": Schema.optionalKey(Schema.Struct({ "redactions": Schema.optionalKey(Schema.Array(RedactionPointer)) })) })
export type PostRedactPage202 = RedactionResponse
export const PostRedactPage202 = RedactionResponse
export type PostRedactBlogRequestJson = { readonly "createdAt": string, readonly "cleanHistory"?: boolean | null, readonly "versionNumber"?: number | null, readonly "body"?: { readonly "redactions"?: ReadonlyArray<RedactionPointer> }, readonly "title"?: { readonly "redactions"?: ReadonlyArray<RedactionPointer> } }
...
export const GetWhiteboardDirectChildrenParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(Schema.String) })
...
export const GetWhiteboardDescendantsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "depth": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(10).annotate({ "expected": "a value less than or equal to 10" }))), "cursor": Schema.optionalKey(Schema.String) })
...
export const GetWhiteboardAncestorsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetDatabaseContentPropertiesParams = Schema.Struct({ "key": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(ContentPropertySortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetDatabaseDirectChildrenParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(Schema.String) })
...
export const GetDatabaseDescendantsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "depth": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(10).annotate({ "expected": "a value less than or equal to 10" }))), "cursor": Schema.optionalKey(Schema.String) })
...
export const GetDatabaseAncestorsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetSmartLinkDirectChildrenParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(Schema.String) })
...
export const GetSmartLinkDescendantsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "depth": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(10).annotate({ "expected": "a value less than or equal to 10" }))), "cursor": Schema.optionalKey(Schema.String) })
...
export const GetSmartLinkAncestorsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export type CreateFolder200 = { readonly "id"?: string, readonly "type"?: string, readonly "status"?: ContentStatus, readonly "title"?: string, readonly "parentId"?: string | null, readonly "parentType"?: ParentContentType | null, readonly "position"?: number | null, readonly "authorId"?: string, readonly "ownerId"?: string, readonly "createdAt"?: string | number, readonly "spaceId"?: string, readonly "version"?: Version, readonly "_links"?: { readonly "webui"?: string, readonly "base"?: string } }
export const CreateFolder200 = Schema.Struct({ "id": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the folder." })), "type": Schema.optionalKey(Schema.String.annotate({ "description": "The content type of the object." })), "status": Schema.optionalKey(ContentStatus), "title": Schema.optionalKey(Schema.String.annotate({ "description": "Title of the folder." })), "parentId": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "ID of the parent content, or null if there is no parent content." })), "parentType": Schema.optionalKey(Schema.Union([ParentContentType, Schema.Null]).annotate({ "description": "Content type of the parent, or null if there is no parent." })), "position": Schema.optionalKey(Schema.Union([Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })), Schema.Null]).annotate({ "description": "Position of the folder within its parent page tree." })), "authorId": Schema.optionalKey(Schema.String.annotate({ "description": "The account ID of the user who created this folder." })), "ownerId": Schema.optionalKey(Schema.String.annotate({ "description": "The account ID of the user who owns this folder." })), "createdAt": Schema.optionalKey(Schema.Union([Schema.String.annotate({ "format": "date-time" }), Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))]).annotate({ "description": "When the folder was created. The upstream spec declares an ISO-8601 string, but the v2 folder endpoints return epoch milliseconds (verified live against GET /folders/{id}), so both are accepted." })), "spaceId": Schema.optionalKey(Schema.String.annotate({ "description": "ID of the space the folder is in." })), "version": Schema.optionalKey(Version), "_links": Schema.optionalKey(Schema.Struct({ "webui": Schema.optionalKey(Schema.String.annotate({ "description": "Web UI link of the content." })), "base": Schema.optionalKey(Schema.String.annotate({ "description": "Base url of the Confluence site." })) })) })
...
export type GetFolderById200 = { readonly "id"?: string, readonly "type"?: string, readonly "status"?: ContentStatus, readonly "title"?: string, readonly "parentId"?: string | null, readonly "parentType"?: ParentContentType | null, readonly "position"?: number | null, readonly "authorId"?: string, readonly "ownerId"?: string, readonly "createdAt"?: string | number, readonly "spaceId"?: string, readonly "version"?: Version, readonly "_links"?: { readonly "webui"?: string, readonly "base"?: string } }
...
export const GetFolderContentPropertiesParams = Schema.Struct({ "key": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(ContentPropertySortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetFolderDirectChildrenParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(Schema.String) })
...
export const GetFolderDescendantsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "depth": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(10).annotate({ "expected": "a value less than or equal to 10" }))), "cursor": Schema.optionalKey(Schema.String) })
...
export const GetFolderAncestorsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetCustomContentVersionsParams = Schema.Struct({ "body-format": Schema.optionalKey(CustomContentBodyRepresentation), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(VersionSortOrder) })
...
export type GetSpacesParams = { readonly "ids"?: ReadonlyArray<number>, readonly "keys"?: ReadonlyArray<string>, readonly "type"?: "global" | "collaboration" | "knowledge_base" | "personal" | "system" | "onboarding" | "xflow_sample_space", readonly "status"?: "current" | "archived" | "trashed", readonly "labels"?: ReadonlyArray<string>, readonly "favorited-by"?: string, readonly "not-favorited-by"?: string, readonly "sort"?: SpaceSortOrder, readonly "description-format"?: SpaceDescriptionBodyRepresentation, readonly "include-icon"?: boolean, readonly "cursor"?: string, readonly "limit"?: number }
export const GetSpacesParams = Schema.Struct({ "ids": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "keys": Schema.optionalKey(Schema.Array(Schema.String).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "type": Schema.optionalKey(Schema.Literals(["global", "collaboration", "knowledge_base", "personal", "system", "onboarding", "xflow_sample_space"])), "status": Schema.optionalKey(Schema.Literals(["current", "archived", "trashed"])), "labels": Schema.optionalKey(Schema.Array(Schema.String)), "favorited-by": Schema.optionalKey(Schema.String), "not-favorited-by": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(SpaceSortOrder), "description-format": Schema.optionalKey(SpaceDescriptionBodyRepresentation), "include-icon": Schema.optionalKey(Schema.Boolean), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetSpacePropertiesParams = Schema.Struct({ "key": Schema.optionalKey(Schema.String), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetSpacePermissionsAssignmentsParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetAvailableSpacePermissionsParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const ListSpacePermissionCombinationsParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetAvailableSpaceRolesParams = Schema.Struct({ "space-id": Schema.optionalKey(Schema.String), "role-type": Schema.optionalKey(Schema.String), "principal-id": Schema.optionalKey(Schema.String), "principal-type": Schema.optionalKey(PrincipalType), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetSpaceRoleAssignmentsParams = Schema.Struct({ "role-id": Schema.optionalKey(Schema.String), "role-type": Schema.optionalKey(Schema.String), "principal-id": Schema.optionalKey(Schema.String), "principal-type": Schema.optionalKey(PrincipalType), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const SetSpaceRoleAssignmentsRequestJson = Schema.Array(Schema.StructWithRest(Schema.Struct({ "principal": Principal, "roleId": Schema.optionalKey(Schema.String.annotate({ "description": "The role to which the principal is assigned." })) }), [Schema.Record(Schema.String, Schema.Json.annotate({ "expected": "JSON value" }))]))
...
export const GetPageFooterCommentsParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "trashed", "deleted", "historical", "draft"]))), "sort": Schema.optionalKey(CommentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetPageInlineCommentsParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "archived", "trashed", "deleted", "historical", "draft"]))), "resolution-status": Schema.optionalKey(Schema.Array(Schema.Literals(["resolved", "open", "dangling", "reopened"]))), "sort": Schema.optionalKey(CommentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetBlogPostFooterCommentsParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "deleted", "trashed", "historical", "draft"]))), "sort": Schema.optionalKey(CommentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetBlogPostInlineCommentsParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "status": Schema.optionalKey(Schema.Array(Schema.Literals(["current", "deleted", "trashed", "historical", "draft"]))), "resolution-status": Schema.optionalKey(Schema.Array(Schema.Literals(["resolved", "open", "dangling", "reopened"]))), "sort": Schema.optionalKey(CommentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetFooterCommentsParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "sort": Schema.optionalKey(CommentSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetFooterCommentByIdParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentationSingle), "version": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "include-properties": Schema.optionalKey(Schema.Boolean), "include-operations": Schema.optionalKey(Schema.Boolean), "include-likes": Schema.optionalKey(Schema.Boolean), "include-versions": Schema.optionalKey(Schema.Boolean), "include-version": Schema.optionalKey(Schema.Boolean) })
...
export const UpdateFooterCommentRequestJson = Schema.Struct({ "version": Schema.optionalKey(Schema.Struct({ "number": Schema.optionalKey(Schema.Number.annotate({ "description": "Number of new version. Should be 1 higher than current version of the comment." }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "message": Schema.optionalKey(Schema.String.annotate({ "description": "Optional message store for the new version." })) })), "body": Schema.optionalKey(Schema.Union([CommentBodyWrite, CommentNestedBodyWrite], { mode: "oneOf" })), "_links": Schema.optionalKey(Schema.Struct({ "base": Schema.optionalKey(Schema.String.annotate({ "description": "Base url of the Confluence site." })) })) })
...
export const GetFooterLikeCount200 = Schema.Struct({ "count": Schema.optionalKey(Schema.Number.annotate({ "description": "The count number", "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) }).annotate({ "title": "Integer" })
export type GetFooterLikeUsersParams = { readonly "cursor"?: string, readonly "limit"?: number }
export const GetFooterLikeUsersParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetInlineLikeCount200 = Schema.Struct({ "count": Schema.optionalKey(Schema.Number.annotate({ "description": "The count number", "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))) }).annotate({ "title": "Integer" })
export type GetInlineLikeUsersParams = { readonly "cursor"?: string, readonly "limit"?: number }
export const GetInlineLikeUsersParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetCommentContentPropertiesParams = Schema.Struct({ "key": Schema.optionalKey(Schema.String), "sort": Schema.optionalKey(ContentPropertySortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetTasksParams = Schema.Struct({ "body-format": Schema.optionalKey(PrimaryBodyRepresentation), "include-blank-tasks": Schema.optionalKey(Schema.Boolean), "status": Schema.optionalKey(Schema.Literals(["complete", "incomplete"])), "task-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "space-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "page-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "blogpost-id": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "created-by": Schema.optionalKey(Schema.Array(Schema.String).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "assigned-to": Schema.optionalKey(Schema.Array(Schema.String).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "completed-by": Schema.optionalKey(Schema.Array(Schema.String).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "created-at-from": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "created-at-to": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "due-at-from": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "due-at-to": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "completed-at-from": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "completed-at-to": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetChildPagesParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(Schema.String) })
...
export const GetChildCustomContentParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(Schema.String) })
...
export const GetPageDirectChildrenParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "sort": Schema.optionalKey(Schema.String) })
...
export const GetPageAncestorsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetPageDescendantsParams = Schema.Struct({ "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))), "depth": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(10).annotate({ "expected": "a value less than or equal to 10" }))), "cursor": Schema.optionalKey(Schema.String) })
...
export const CreateBulkUserLookupRequestJson = Schema.Struct({ "accountIds": Schema.Array(Schema.String).annotate({ "description": "List of accountIds to retrieve user info for." }).check(Schema.isMinLength(1).annotate({ "expected": "a value with a length of at least 1" })).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" })) })
...
export const CheckAccessByEmailRequestJson = Schema.Struct({ "emails": Schema.Array(Schema.String).annotate({ "description": "List of emails to check access to site." }).check(Schema.isMinLength(1).annotate({ "expected": "a value with a length of at least 1" })).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" })) })
...
export const InviteByEmailRequestJson = Schema.Struct({ "emails": Schema.Array(Schema.String).annotate({ "description": "List of emails to check access to site." }).check(Schema.isMinLength(1).annotate({ "expected": "a value with a length of at least 1" })).check(Schema.isMaxLength(100).annotate({ "expected": "a value with a length of at most 100" })) })
...
export const GetDataPolicySpacesParams = Schema.Struct({ "ids": Schema.optionalKey(Schema.Array(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" }))).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "keys": Schema.optionalKey(Schema.Array(Schema.String).check(Schema.isMaxLength(250).annotate({ "expected": "a value with a length of at most 250" }))), "sort": Schema.optionalKey(SpaceSortOrder), "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
...
export const GetAttachmentThumbnailByIdParams = Schema.Struct({ "version": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "height": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))), "width": Schema.optionalKey(Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" }))) })
export type GetForgeAppPropertiesParams = { readonly "cursor"?: string, readonly "limit"?: number }
export const GetForgeAppPropertiesParams = Schema.Struct({ "cursor": Schema.optionalKey(Schema.String), "limit": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(1).annotate({ "expected": "a value greater than or equal to 1" })).check(Schema.isLessThanOrEqualTo(250).annotate({ "expected": "a value less than or equal to 250" }))) })
