 ...
 * @category Services
 */
export class VersionService extends Context.Tag("@knpkv/jira-cli/VersionService")<
  VersionService,
  VersionServiceShape
>() {}
...
const make = Effect.gen(function*() {
  ...
  const resolveFieldIds = (name: string): Effect.Effect<ReadonlyArray<string>, JiraApiError> =>
    Effect.gen(function*() {
