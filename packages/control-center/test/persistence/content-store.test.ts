...
describe("ContentStore", () => {
  descriptorIt.effect(
    "publishes bytes first, isolates workspaces, and preserves verification monotonicity",
    () =>
      Effect.gen(function*() {
  ...
  descriptorIt.effect(
    "does not certify bytes whose persisted length metadata is inconsistent",
    () =>
      Effect.gen(function*() {
  ...
  descriptorIt.effect(
    "maps missing reproducible cache reads while preserving healthy and durable behavior",
    () =>
      Effect.gen(function*() {
  ...
  descriptorIt.effect(
    "maps premature EOF for reproducible ranges, verification, and lazy streams",
    () =>
      Effect.gen(function*() {
  ...
  descriptorIt.effect(
    "surfaces corrupt reproducible bytes as restart-visible refetch state",
    () =>
      Effect.gen(function*() {
  ...
  descriptorIt.effect(
    "never authorizes durable replacement from a cache-classified retry",
    () =>
      Effect.gen(function*() {
