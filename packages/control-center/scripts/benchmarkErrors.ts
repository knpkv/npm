...
export class BenchmarkInvariantError extends Schema.TaggedError<BenchmarkInvariantError>()(
  "BenchmarkInvariantError",
  { reason: Schema.String }
) {}

/** A durable benchmark report could not be collected, encoded, written, read, or decoded. */
export class BenchmarkReportError extends Schema.TaggedError<BenchmarkReportError>()("BenchmarkReportError", {
  reason: Schema.String
}) {}
