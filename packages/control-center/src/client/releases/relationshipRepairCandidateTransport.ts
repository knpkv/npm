...
import type { RelationshipId, RelationshipRepairProposalId, ReleaseId } from "../../domain/identifiers.js"
...
export interface RelationshipRepairCandidateTransport {
  ...
  readonly list: (releaseId: ReleaseId, signal: AbortSignal) => Promise<RelationshipRepairCandidates>
...
export const browserRelationshipRepairCandidateTransport: RelationshipRepairCandidateTransport = {
  ...
  draft: (releaseId, relationshipId, revision, signal) =>
    Effect.runPromise(
      Effect.gen(function*() {
