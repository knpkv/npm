...
export class CredentialRejectedError extends Schema.TaggedError<CredentialRejectedError>()(
  "CredentialRejectedError",
  {}
) {}

/** Authenticated actor lacks the workspace-owner permission required by an operation. */
export class AuthPermissionDeniedError extends Schema.TaggedError<AuthPermissionDeniedError>()(
  "AuthPermissionDeniedError",
  {}
) {}

/** A workspace has already issued its unique first-run owner code. */
export class FirstRunPairingAlreadyIssuedError extends Schema.TaggedError<FirstRunPairingAlreadyIssuedError>()(
  "FirstRunPairingAlreadyIssuedError",
  {}
) {}

/** Stable secret-free boundary error for an authentication persistence failure. */
export class AuthPersistenceError extends Schema.TaggedError<AuthPersistenceError>()(
...
export class TerminalRecoveryRefusedError extends Schema.TaggedError<TerminalRecoveryRefusedError>()(
