...
import type { ConfirmPayload, DescribeRowRequest } from "../src/shared/contracts.js"
...
type RoutePayload = SessionAgentSettings | Schema.Schema.Type<typeof ConfirmPayload> | Omit<DescribeRowRequest, "rowId">
...
const makeApplication = async (
  ...
  const calls = { describe: 0, ownership: 0, settings: new Array<SessionAgentSettings>() }
