...
describe("component manifest contract", () => {
  ...
  it("projects manifest-owned component styles in deterministic build order", () => {
    ...
    expect(componentStyleSources(manifest)).toEqual([
      ...
      "src/patterns/RelationshipChain.module.css",
      "src/patterns/RelationshipTable.module.css",
      "src/patterns/ReleasePreview.module.css",
      "src/patterns/ReleaseRelay.module.css",
      "src/patterns/ReleaseRow.module.css",
      "src/patterns/ServiceMark.module.css",
      "src/patterns/StageRail.module.css",
      "src/patterns/TimelineRow.module.css",
      "src/patterns/Verdict.module.css",
  ...
  it("rejects variant defaults outside their values", () => {
    const manifest: ComponentManifest = {
      ...componentManifest,
      registryMetadata: { Button: buttonRegistryMetadata },
      components: [
        {
          category: "primitive",
  ...
  it("detects missing records and undeclared component sources", () => {
    ...
    expect(
      findSourceDrift(componentManifest, [...files, "src/primitives/undeclared.tsx", "src/primitives/undeclared.css"])
    ).toEqual({
      missing: [],
    ...
    expect(
      findSourceDrift(
        componentManifest,
        files.filter((file) => file !== "src/primitives/index.ts")
      )
    ).toEqual({
