  ...
  return (
    ...
    >
      <box style={{ flexDirection: "row", gap: 2 }}>
        <text fg="#00CC66" style={{ fontWeight: "bold" } as any}>
          ●
        </text>
      ...
      <box style={{ flexDirection: "row", gap: 1, paddingLeft: 2 } as any}>
        <text fg="#FFFFFF" style={{ fontWeight: "bold" } as any}>
          {timerState.ticketKey}
        </text>
        <text fg="#AAAAAA">{timerState.summary ?? ""}</text>
      </box>
      <box style={{ flexDirection: "row", gap: 2, paddingLeft: 2 } as any}>
