      ...
      <box style={{ flexDirection: "row" }}>
        ...
        >
          <text fg={filterType === "date" ? theme.selectedText : theme.textMuted}>
            [6] Age{filterType === "date" && filterValue ? `: ${filterValue === "today" ? "24h" : filterValue === "week" ? "7d" : filterValue === "month" ? "30d" : "30d+"}` : ""}
          </text>
        </box>
        <box
          style={{
        ...
        {(filterType === "account" || filterType === "author" || filterType === "scope" || filterType === "date" || filterType === "repo" || filterType === "status") && (
