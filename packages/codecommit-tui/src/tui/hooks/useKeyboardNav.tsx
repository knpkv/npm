...
import { appStateAtom, clearNotificationsAtom, notificationsAtom, refreshAtom, setAllAccountsAtom } from "../atoms/app.js"
import {
  currentPRAtom,
  currentUserAtom,
  exitPendingAtom,
...
import type { AppState } from "../../PRService.js"
    ...
    if (view === "settings") {
      if (key.name === "a") {
        ...
        const profiles = settingsFilter
          ? appState.accounts.filter((a) => a.profile.toLowerCase().includes(settingsFilter.toLowerCase())).map((a) => a.profile)
          : null
    ...
    switch (key.name) {
      ...
      case "left":
        if (view === "prs") {
          ...
          } else if (quickFilterType === "account" || quickFilterType === "author" || quickFilterType === "scope" || quickFilterType === "repo") {
            const list = quickFilterType === "account" ? accounts : quickFilterType === "author" ? authors : quickFilterType === "repo" ? repos : scopes
