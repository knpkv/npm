// Captured from codex-cli 0.154.0: `codex features list` (no generation).
// Keep independent of production classification lists so newly shipped flags cannot disappear from the test.
export const version = "codex-cli 0.154.0"
export const inventory = `apply_patch_freeform                     removed            false
